...
To find the upstream git commit rtl_433 was built from, drop the leading `g`. In the above example, rtl_433 was built with 89 commits since the 22.11 release, in git commit `416d6c4f`, which can be found at https://github.com/n6ham/rtl_433/commit/416d6c4f9768f22e7b4cfdd684c58df17c946dbc.
